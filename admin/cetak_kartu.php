...
// 1. Perbarui Query untuk Join ke tabel ruang_ujian & kartu RFID
// Menggunakan LEFT JOIN agar siswa yang belum dapat ruangan atau kartu tetap muncul
 $query = mysqli_query($conn, "SELECT siswa.*, kelas.nama_kelas, ruang_ujian.nama_ruang, kr.uid_rfid 
         FROM siswa 
         JOIN kelas ON siswa.id_kelas = kelas.id_kelas 
         LEFT JOIN ruang_ujian ON siswa.id_ruang = ruang_ujian.id_ruang
         LEFT JOIN kartu_rfid kr ON siswa.id_siswa = kr.siswa_id
    ...
    <div class="card">
        ...
        <div class="content">
            <table>
                ...
                <tr>
                    <td>Ruang Ujian</td>
                    <td>: <span class="badge-ruang"><?= ($row['nama_ruang']) ? htmlspecialchars($row['nama_ruang']) : 'Belum Diatur'; ?></span></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Username</td>
                    <td>: <strong><?= htmlspecialchars($row['nisn']); ?></strong></td>
                </tr>
                <tr>
                    <td>Password</td>
                    <td>: <strong><?= htmlspecialchars($row['nisn']); ?></strong></td>
        ...
        <div class="footer">
            <strong style="font-family: 'Courier New', monospace; letter-spacing: 1px;">UID Kartu: <?= ($row['uid_rfid']) ? $row['uid_rfid'] : 'BELUM TERDAFTAR'; ?></strong><br>
