...
$q_nilai = mysqli_query($conn, "SELECT u.id_ujian, s.nis, s.nama_siswa, k.nama_kelas, k.id_kelas,
    ...
    <div class="col-6 col-lg-2">
        <div class="stat-card">
            <div class="text-center">
                ...
                <div class="stat-value text-dark mt-1"><?= $stats['total_peserta']; ?></div>
            </div>
        </div>
    </div>
    <div class="col-6 col-lg-2">
...
<div class="card card-custom p-4 mb-4">
    ...
    <div class="row g-3">
        ...
        foreach ($grades as $g):
            $pct = $stats['total_peserta'] > 0 ? round(($g[1] / $stats['total_peserta']) * 100) : 0;
        ?>
        <div class="col">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <small class="text-muted"><?= htmlspecialchars($v['nis']); ?></small>
                    </td>
                    <td class="text-center">
        ...
        <table class="table table-hover align-middle mb-0">
            <thead class="bg-light">
                <tr>
                    ...
                    <th class="text-center small text-muted">Tertinggi</th>
                    <th class="text-center small text-muted">Terendah</th>
                    <th class="text-center small text-muted">Lulus</th>
                    <th class="text-center small text-muted">Tidak Lulus</th>
                    <th class="text-center small text-muted">Export</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><span class="badge bg-light text-dark border"><?= $pu['nama_kelas'] ?? '-'; ?></span></td>
                    <td class="text-center small text-muted"><?= date('d M Y', strtotime($pu['tgl_mulai'])); ?></td>
                    ...
                    <td class="text-center fw-bold text-success"><?= $pu['tertinggi']; ?></td>
                    <td class="text-center fw-bold text-danger"><?= $pu['terendah']; ?></td>
                    <td class="text-center">
                        <span class="fw-bold text-success"><?= $pu['lulus']; ?></span>
                        <small class="text-muted">(<?= $pct_lulus; ?>%)</small>
                    </td>
                    <td class="text-center">
